...
class Runner_MAPPO_MPE:
    def __init__(self, args, env_name, number, seed):
        ...
        # Create env
        self.env = make_env()#make_env(env_name, discrete=True) # Discrete action space
        self.args.N = self.env.multi_agent_cnt  # The number of agents
        self.args.obs_dim_n = [10 for i in range(self.args.N)]  # obs dimensions of N agents
        self.args.action_dim_n = [12 for i in range(self.args.N)]  # actions dimensions of N agents
